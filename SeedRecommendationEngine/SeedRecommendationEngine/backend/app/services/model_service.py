...
class ModelService:
    ...
    def _to_feature_dataframe(self, payload: InputFeatures):
        import pandas as pd
        ...
        data = {feature: [getattr(payload, feature)] for feature in feature_order}
        return pd.DataFrame(data)

    def predict(self, payload: InputFeatures) -> PredictionResponse:
        self._load_model()
        features = self._to_feature_dataframe(payload)
